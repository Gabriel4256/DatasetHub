<template>
    <!-- Off-Canvas Menu-->
    <div v-bind:class = "{'in-view': inView}" class="offcanvas-container is-triggered offcanvas-container-reverse" id="mobile-menu"><span v-on:click="hide" class="offcanvas-close"><i class="fe-icon-x"></i></span>
      <div class="px-4 pb-4">
        <h6>Menu</h6>
        ...
        <div class="accordion mobile-menu" id="accordion-menu">
          ...
          <div class="card">
            <div class="card-header">
                <a class="mobile-menu-link active" href="index.html">Home</a>
                    <a class="collapsed" href="#home-submenu" data-toggle="collapse">
                </a>
            </div>
